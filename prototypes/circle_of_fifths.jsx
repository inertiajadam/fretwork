...
/* Correctly spelled major scales for all twelve keys */
const SCALES = {
  "C":  ["C","D","E","F","G","A","B"],
  "G":  ["G","A","B","C","D","E","F#"],
  "D":  ["D","E","F#","G","A","B","C#"],
...
.maj-txt { font-family: 'Fraunces', serif; font-size: 21px; font-weight: 650; }
.min-txt { font-size: 13px; font-weight: 600; font-family: ui-sans-serif, system-ui, sans-serif; }
.sig-txt { font-family: 'JetBrains Mono', monospace; font-size: 10px; fill: #7A6F60; }
.center-key { font-family: 'Fraunces', serif; font-size: 40px; font-weight: 650; fill: #EFE6D9; }
.center-sub { font-size: 13px; fill: #A89B8A; font-family: ui-sans-serif, system-ui, sans-serif; }
.center-sig { font-family: 'JetBrains Mono', monospace; font-size: 12px; fill: #E8A33D; }
...
.dnum { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; color: var(--muted); }
...
.prog-name { font-family: 'Fraunces', serif; font-size: 15px; font-weight: 650; }
.prog-nums { font-family: 'JetBrains Mono', monospace; font-size: 12px; color: var(--amber); }
