...
.guide-col h3 {
  font-family: 'Fraunces', serif; font-weight: 650; font-size: 17px;
...
.shape-badge {
  ...
  font-family: 'Fraunces', serif; font-size: 20px; font-weight: 650;
}
.shape-panel h3 { font-family: 'Fraunces', serif; font-weight: 650; font-size: 20px; margin: 0; }
.shape-meta {
...
.chip.shape { min-width: 42px; font-family: 'Fraunces', serif; font-size: 16px; }
...
.flag-txt { font-family: 'JetBrains Mono', monospace; font-size: 11px; font-weight: 500; fill: #1A130E; }
.str-name { font-family: 'JetBrains Mono', monospace; font-size: 12px; fill: var(--muted); }
.fret-num { font-family: 'JetBrains Mono', monospace; font-size: 13px; fill: var(--muted); }
.mark-txt { font-size: 11.5px; font-weight: 700; fill: #1A130E; font-family: ui-sans-serif, system-ui, sans-serif; }
...
.big-key { font-family: 'Fraunces', serif; font-size: 34px; font-weight: 650; }
