...
const noteName = (midi) => SHARP[((midi % 12) + 12) % 12] + (Math.floor(midi / 12) - 1);
...
.app {
  ...
  --ink: #EFE6D9; --muted: #A89B8A; --amber: #E8A33D; --green: #86B36B;
...
.ref-val { font-family: 'JetBrains Mono', monospace; font-size: 13px; min-width: 64px; text-align: center; }
...
.tick-txt { font-family: 'JetBrains Mono', monospace; font-size: 11px; fill: #A89B8A; }
.side-txt { font-family: 'JetBrains Mono', monospace; font-size: 10px; fill: #7A6F60; letter-spacing: 0.06em; }
...
.big-note { font-family: 'Fraunces', serif; font-size: 56px; font-weight: 650; line-height: 1; }
.big-note.idle { color: #4A3F35; }
.readout.good .big-note { color: var(--green); }
.read-line { font-family: 'JetBrains Mono', monospace; font-size: 12.5px; color: var(--muted); }
.readout.good .read-line { color: var(--green); }

.string-row { display: flex; gap: 8px; flex-wrap: wrap; justify-content: center; }
.string-chip { background: var(--panel2); border: 1.5px solid var(--line); border-radius: 10px; padding: 8px 13px; font-size: 14px; font-weight: 700; font-family: 'JetBrains Mono', monospace; }
