...
.num-chip b { font-size: 16px; font-family: 'Fraunces', serif; }
.num-chip i { font-style: normal; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--muted); }
...
.snum { font-family: 'Fraunces', serif; font-size: 24px; font-weight: 650; color: var(--amber); line-height: 1; }
.schord { font-size: 15px; font-weight: 700; }
.schord.alt { font-size: 13px; color: var(--muted); font-weight: 600; }
.strip-caption { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; color: #7A6F60; margin: 0; letter-spacing: 0.04em; }
...
.score-num { font-family: 'Fraunces', serif; font-size: 20px; font-weight: 650; color: var(--amber); }
.score-word { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--muted); }
...
.q-text b { font-family: 'Fraunces', serif; font-size: 22px; color: var(--amber); }
