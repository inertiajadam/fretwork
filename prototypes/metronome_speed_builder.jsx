...
.app {
  ...
  --ink: #EFE6D9; --muted: #A89B8A; --amber: #E8A33D; --green: #86B36B; --red: #E36B5C;
...
.bpm-num { font-family: 'Fraunces', serif; font-size: 62px; font-weight: 650; line-height: 1; color: var(--ink); }
.bpm-word { font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; color: var(--muted); margin-top: 4px; }
.mini-btn { background: var(--panel2); border: 1.5px solid var(--line); color: var(--ink); border-radius: 10px; padding: 9px 14px; font-size: 14px; font-weight: 700; cursor: pointer; font-family: 'JetBrains Mono', monospace; }
...
.sb-config label { display: flex; flex-direction: column; gap: 5px; font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--muted); }
...
.ladder-label { position: absolute; top: 50%; transform: translateY(-50%); font-family: 'JetBrains Mono', monospace; font-size: 11px; color: var(--ink); }
