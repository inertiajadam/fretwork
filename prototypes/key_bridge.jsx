...
.relation b { font-family: 'Fraunces', serif; font-size: 17px; }
...
.psub { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; color: var(--amber); }
...
.route h3 { font-family: 'Fraunces', serif; font-weight: 650; font-size: 18px; margin: 0; }
...
.ssub { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--amber); white-space: nowrap; }
...
.pal-label { font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--muted); }
...
.pal-chip i { font-style: normal; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--muted); }
