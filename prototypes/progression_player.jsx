...
.now-label { font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase; color: var(--muted); }
.now-chord { font-family: 'Fraunces', serif; font-size: 58px; font-weight: 650; line-height: 1; color: var(--amber); }
.now-num { font-family: 'JetBrains Mono', monospace; font-size: 13px; color: var(--muted); }
.next-chord { font-family: 'Fraunces', serif; font-size: 30px; font-weight: 650; line-height: 1; color: var(--ink); opacity: 0.75; }
...
.bar-num { font-family: 'Fraunces', serif; font-size: 19px; font-weight: 650; color: var(--amber); line-height: 1; }
